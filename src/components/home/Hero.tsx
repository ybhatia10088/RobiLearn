          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black leading-tight mb-8">
                <div className="text-white whitespace-nowrap">Master Robotics</div>
                <div className="bg-gradient-to-r from-primary-400 via-secondary-400 to-accent-400 bg-clip-text text-transparent font-black whitespace-nowrap">
                  Without Hardware
                </div>
              </h1>

              {/* Subtitle */}
              <p className="text-xl md:text-2xl lg:text-3xl text-dark-200 mb-12 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light">
              ...
              {/* Social proof */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 text-sm text-dark-300">
              ...
              <div className="relative w-full max-w-2xl">
                ...
                <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-dark-700/80 to-dark-800/80 rounded-3xl overflow-hidden backdrop-blur-xl border border-dark-600/30 shadow-2xl">
                  ...
                  <div className="h-[calc(100%-56px)] bg-gradient-to-br from-primary-900/10 via-dark-800/30 to-secondary-900/10 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 w-40 h-40 bg-gradient-to-br from-primary-400 via-secondary-400 to-accent-400 rounded-3xl shadow-2xl shadow-primary-500/30 flex items-center justify-center backdrop-blur-sm transform transition-transform hover:scale-110 duration-500">
                      <Cpu size={64} className="text-white drop-shadow-lg" />
                    </div>
                    
                    {/* Feature elements */}
                    <div className="absolute top-1/4 left-1/4 w-20 h-20 bg-accent-500/15 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                      <Brain size={32} className="text-accent-400" />
                    </div>
                    <div className="absolute bottom-1/4 right-1/4 w-16 h-16 bg-secondary-500/15 rounded-xl flex items-center justify-center backdrop-blur-sm">
                      <Layers size={28} className="text-secondary-400" />
                    </div>
                    
                    {/* Code snippets */}
                    <div className="absolute top-1/3 right-1/6 bg-dark-700/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                      <div className="text-xs font-mono text-primary-400">robot.move()</div>
                    </div>
                    <div className="absolute bottom-1/3 left-1/6 bg-dark-700/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                      <div className="text-xs font-mono text-secondary-400">sensor.read()</div>
                    </div>
                  </div>
                </div>
                
                {/* Floating elements */}
                <div className="absolute -top-6 -right-6 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-4 shadow-xl shadow-primary-500/30">
                  <Play size={24} className="text-white" />
                </div>
                <div className="absolute -bottom-6 -left-6 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-2xl p-4 shadow-xl shadow-secondary-500/30">
