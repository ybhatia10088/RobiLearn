...
const AboutPage: React.FC = () => {
  const founders = [
    ...
    },
    {
      ...
      quote: 'I built the kind of tool I wished I had when I first started learning robotics.',
      linkedin: '#',
  ...
  const stats = [
    ...
    { number: '50+', label: 'Universities', icon: <BookOpen size={24} /> },
    { number: '100+', label: 'Challenges', icon: <Target size={24} /> },
